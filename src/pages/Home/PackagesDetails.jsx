    ...
    return (
        <div className="max-w-screen-xl mx-auto">
            ...
            <div className=" md:h-[600px]">
                <div className="">
                    <Slider images={ packageDetails }></Slider>
                </div>
            </div>
            <h1 className="text-3xl font-semibold my-5">{ tripTitle }</h1>
            ...
            <section className="space-y-8 my-10">
                <h1 className="text-3xl font-bold text-center">Overview Packages</h1>
                ...
                <button className="bg-[#FE5C24] text-white py-4 px-10 font-bold text-xl rounded">Booking Now!</button>
                </div>
            </section>
        </div>
    );
